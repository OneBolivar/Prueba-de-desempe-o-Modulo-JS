    ...
    <div class="min-h-screen bg-gray-100 flex">
      ...
      <main class="flex-1 p-8 overflow-y-auto">
        <header class="mb-8">
          ...
          <p class="text-gray-600 mt-1">Métricas globales del sistema de reservas de la empresa.</p>
        </header>

        <!-- Tarjetas de Estadísticas Requeridas -->
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            <p class="text-sm font-medium text-gray-500 uppercase">Pendientes por Revisar</p>
            <p id="stat-pending" class="text-3xl font-bold text-amber-500 mt-2">0</p>
          </div>
        </div>

        <!-- Listado Maestro de Gestión -->
        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
